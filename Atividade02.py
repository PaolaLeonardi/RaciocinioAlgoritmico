...
#O programa utiliza a fórmula de conversão para Fahrenheit (C × 9/5 + 32) para transformar a temperatura e mostrar o resultado na tela.
...
#No Exercício 04, o programa pede quatro notas ao usuário. Depois, ele soma todas as notas e divide por quatro para calcular a média final.
...
#No Exercício 05, o programa pede o ano de nascimento novamente, calcula a idade usando o ano atual e depois multiplica a idade por 12 para descobrir a idade em meses.
